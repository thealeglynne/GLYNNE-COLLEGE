...
export default function CloudinaryPlayer() {
  return (
    <div className="relative w-full max-w-6xl mx-auto aspect-video">
      <video
        src="https://res.cloudinary.com/dpdyco5po/video/upload/f_auto,q_auto/RLo2_ee588t.mp4"
        poster="https://res.cloudinary.com/dpdyco5po/video/upload/RLo2_ee588t.jpg"
        controls
        playsInline
