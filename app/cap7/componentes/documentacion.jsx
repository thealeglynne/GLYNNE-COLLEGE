...
const docs = [
  // ==================== Documentación Serper ====================
  {
    icon: <FaExternalLinkAlt size={40} className="text-orange-500 drop-shadow-sm" />,
    title: 'Serper Oficial',
    description: 'Documentación oficial de Serper API para búsquedas web.',
    detail: 'Guía completa de cómo realizar consultas web, integrar resultados en tus agentes y obtener respuestas contextuales en Python.',
    link: 'https://serper.dev/?utm_term=serpapi&gad_source=1&gad_campaignid=18303173259&gbraid=0AAAAAo4ZGoGPLVt1JEsTdURWwWrQvkSk0&gclid=Cj0KCQjw8p7GBhCjARIsAEhghZ0s8I-VwB_RAznC9A945T6ZavQ8p0GRAENsu8DgHX1OOUE8-cj8kZAaAi0GEALw_wcB'
  },
  ...
  },
  {
    ...
    link: 'https://langchain-ai.github.io/langgraphjs/tutorials/quickstart/?ajs_aid=fc487dc1-6cce-48f9-8419-3f2511d38995&_gl=1*4yph64*_gcl_au*MjEzMTAwNjMyNy4xNzU2MTQyODIy*_ga*NTM4NTQxMjYwLjE3NTYxNDI4MjM.*_ga_47WX3HKKY2*czE3NTc5Njg4MjQkbzUkZzAkdDE3NTc5Njg4MjQkajYwJGwwJGgw'
  },
  {
    icon: <FaTools size={40} className="text-orange-500 drop-shadow-sm" />,
    title: 'Edges y Flujo',
