...
const docs = [
  ...
  {
    icon: <FaFileCode size={40} className="text-orange-500 drop-shadow-sm" />,
    title: 'Prompting Guide',
    description: 'Ejemplos y buenas prácticas de prompts.',
    detail: 'Guía práctica para aprender cómo escribir prompts efectivos para LLMs.',
    link: 'https://www.promptingguide.ai/es/introduction/examples'
  },
  {
    icon: <FaFileAlt size={40} className="text-orange-500 drop-shadow-sm" />,
    title: 'PromptTemplate LangChain',
    description: 'Plantillas para prompts dinámicos.',
    detail: 'PromptTemplate permite definir prompts parametrizables y consistentes para LLMs en LangChain.',
  ...
  },
  {
    ...
    description: 'Cómo ejecutar el chat LLM localmente.',
    detail: 'Script principal para interactuar con LLM en consola, formateo de prompts y respuestas.',
    link: 'https://www.langchain.com/docs/getting-started/'
  },
  {
    icon: <FaDatabase size={40} className="text-orange-500 drop-shadow-sm" />,
    title: 'Configuración LLM',
    description: 'Ajustes de temperatura y modelo.',
    detail: 'Cómo configurar parámetros de Groq/LLM para optimizar las respuestas.',
    link: 'https://www.langchain.com/docs/modules/models/llms/'
  },
  {
    icon: <FaServer size={40} className="text-orange-500 drop-shadow-sm" />,
    title: 'Almacenamiento de Datos',
    description: 'Historial y respuestas del LLM.',
    detail: 'Estrategias para guardar y recuperar prompts/respuestas en archivos o bases de datos.',
    link: 'https://www.langchain.com/docs/modules/chains/'
  },
  {
    icon: <FaBookOpen size={40} className="text-orange-500 drop-shadow-sm" />,
    title: 'Buenas Prácticas',
    description: 'Consejos para mantener código limpio.',
    detail: 'Recomendaciones para estructurar prompts, manejar errores, logging y mantener tu integración escalable.',
    link: 'https://www.langchain.com/docs/concepts/best-practices/'
  },
];
      ...
      <div className="relative z-10 w-full max-w-[90vw] flex flex-col items-center text-center space-y-10 p-6 sm:p-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-extrabold uppercase tracking-wide text-gray-900">
            Documentación LLM y LangChain
          </h2>
          <p className="text-gray-700 max-w-3xl mx-auto mt-4 text-base md:text-lg">
            Accede a las guías oficiales y ejemplos de uso de cada componente del código Python de LangChain/Groq que estamos utilizando.
          </p>
        </motion.div>
