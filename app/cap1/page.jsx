...
import ChatGroqTutorial from './components/scriptejm'
import ChatGroqExplained from './components/desfracmentarCodigo'
...
export default function Cap1Page() {
  ...
  const [activeTab, setActiveTab] = useState('tutorial') // 👈 controla qué sección se muestra
