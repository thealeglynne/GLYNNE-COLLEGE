      ...
      <div className="relative z-20 w-full h-full flex items-center justify-center px-4 sm:px-6">
        <div className="w-full max-w-xl p-6 sm:p-8 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-xl text-white text-center space-y-4">
          ...
          <h2 className="text-sm sm:text-base font-medium">
            Bienvenido a <span className="font-bold text-white">GLY-IA College</span>
          </h2>

          <p className="text-xs sm:text-sm text-white/80">
            Tu plataforma de <span className="font-bold text-white">aprendizaje en inteligencia artificial</span>, diseñada para que domines la
            creación de procesos de automatización y lleves tus ideas a otro nivel.
          </p>

          <p className="text-xs sm:text-sm text-white/80">
            Aprende, experimenta y construye soluciones reales. <br />
          ...
          >
            ...
            <span className="relative z-10">Empieza tu aprendizaje</span>
          </button>
        </div>
      </div>
