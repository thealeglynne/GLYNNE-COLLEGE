...
export default function PerfilUsuario() {
  ...
  return (
    <div className="w-full max-w-xl mx-auto bg-white shadow-md rounded-2xl p-6 text-center border border-gray-100">
      <img
      ...
      <div className="mt-4 px-4 py-2 rounded-lg bg-gray-50 border border-gray-200">
        <p className="text-gray-600 text-sm">
          ¡Bienvenido a <span className="font-bold text-black">GLY_College</span>!
        </p>
