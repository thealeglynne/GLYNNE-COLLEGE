        ...
        >
          ...
          >
            <div className="w-full flex flex-col items-center justify-center gap-[2vh]">
              ...
              >
                Bienvenido a <span className="text-black">GLY-AI College</span>
              </motion.h2>
              ...
              >
                Prepárate para un viaje <span className="font-bold">full práctico de desarrollo de IA desde su ADN</span>.<br /><br />
                Verás cómo funciona la IA desde la <span className="font-bold">matemática que la impulsa</span>, hasta cómo darle <span className="font-bold">cuerpo y personalidad real</span>.<br /><br />
                Cada módulo te permitirá <span className="font-bold">experimentar, construir y comprender</span> el corazón de los agentes inteligentes, paso a paso.
              </p>
