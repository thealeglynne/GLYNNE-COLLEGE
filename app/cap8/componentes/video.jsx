...
export default function CloudinaryPlayer() {
  return (
    <div className="relative w-full max-w-6xl mx-auto aspect-video">
      <video
        src="https://res.cloudinary.com/dpdyco5po/video/upload/f_auto,q_auto/cap6-2_urftoj.mp4"
        poster="https://res.cloudinary.com/dpdyco5po/video/upload/cap6-2_urftoj.jpg"
        controls
        playsInline
