...
import { 
  ...
  FaCodeBranch, FaCogs, FaNetworkWired, FaBrain, FaTerminal, FaKey 
} from 'react-icons/fa';
...
const docs = [
  ...
  {
    icon: <FaCodeBranch size={40} className="text-orange-500 drop-shadow-sm" />,
    title: 'LangChain Documentation',
    description: 'Documentación oficial de LangChain.',
    detail: 'Explica cómo crear cadenas, agentes y herramientas personalizadas con LangChain.',
    link: 'https://python.langchain.com/docs/'
  },
  {
    icon: <FaCogs size={40} className="text-orange-500 drop-shadow-sm" />,
    title: 'LangChain Agents',
    description: 'Agentes de LangChain paso a paso.',
    detail: 'Detalla cómo funcionan los agentes, roles dinámicos, orquestación y decisiones de LLM.',
    link: 'https://python.langchain.com/docs/modules/agents/'
  },
  {
    icon: <FaNetworkWired size={40} className="text-orange-500 drop-shadow-sm" />,
    title: 'Groq API',
    description: 'Uso de Groq como backend para LLMs.',
    detail: 'Explica cómo integrar Groq con LangChain y manejar conversaciones optimizadas.',
    link: 'https://docs.groq.com/'
  },
  {
    icon: <FaBrain size={40} className="text-orange-500 drop-shadow-sm" />,
    title: 'LLM Role Management',
    description: 'Roles e instrucciones en LLMs.',
    detail: 'Ejemplos de cómo asignar roles como "auditor", "desarrollador" o "asesor" dentro de un LLM.',
    link: 'https://platform.openai.com/docs/guides/gpt/chat-completions-api'
  },
  {
    icon: <FaTerminal size={40} className="text-orange-500 drop-shadow-sm" />,
    title: 'FastAPI & LLM Integration',
    description: 'Guía para crear APIs con FastAPI y LLMs.',
    detail: 'Cómo exponer endpoints para conversaciones, propuestas técnicas y auditorías con IA.',
    link: 'https://fastapi.tiangolo.com/'
  },
  {
    icon: <FaKey size={40} className="text-orange-500 drop-shadow-sm" />,
    title: 'Environment Variables (.env)',
    description: 'Gestión de variables de entorno seguras.',
    detail: 'Cómo usar dotenv para manejar claves de API en proyectos con IA.',
      ...
      <div className="relative z-10 w-full max-w-[90vw] flex flex-col items-center text-center space-y-10 p-6 sm:p-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-extrabold uppercase tracking-wide text-gray-900">
            Recursos Oficiales de Anatomía de Prompts y Roles en LLMs
          </h2>
          <p className="text-gray-700 max-w-3xl mx-auto mt-4 text-base md:text-lg">
            Explora guías, ejemplos y documentación oficial para diseñar prompts, manejar roles, y construir agentes con LangChain y Groq.
          </p>
        </motion.div>
