...
export default function CloudinaryPlayer() {
  return (
    <div className="relative w-full max-w-6xl mx-auto aspect-video">
      <video
        src="https://res.cloudinary.com/dpdyco5po/video/upload/f_auto,q_auto/cienncia5_rel7co.mp4"
        poster="https://res.cloudinary.com/dpdyco5po/video/upload/cienncia5_rel7co.jpg"
        controls
        playsInline
